      ...
      <Container>
        <Reveal>
          <TiltCard intensity={5} lift={10} glare={false}>
            <div className="relative overflow-hidden rounded-[2rem] border border-gold/20 bg-linear-to-b from-surface to-ink-soft px-8 py-16 text-center [transform-style:preserve-3d] shadow-depth sm:px-16 sm:py-20">
              {/* Live gold particle field */}
              <ParticleField density={70} className="opacity-70" />
